...
export default function Gifts() {
  ...
  // Configurar animación para ejecutarse una vez al montar el componente
  useEffect(() => {
    setHasAnimated(true);
  }, []);
      ...
      <section id="gifts" className="min-h-screen relative overflow-hidden">
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          >
            ...
            >
              <div className="h-px w-8 bg-gold-200/50" />
          ...
          <div className="max-w-2xl mx-auto grid gap-6">
            {config.data.banks.map((account, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-gold-100/50 to-pink-100/50 rounded-2xl transform transition-transform group-hover:scale-105 duration-300" />
                <div className="relative backdrop-blur-sm bg-white/80 p-6 rounded-2xl border border-gold-100/50 shadow-lg">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 rounded-lg bg-white p-2 shadow-sm">
                        <Building2 className="w-full h-full text-gold-500" />
                      </div>
                      <div>
                  ...
                  <div className="mt-4">
                    <div className="flex items-center justify-between bg-gray-50/80 px-4 py-3 rounded-lg">
                      ...
                      <motion.button
                        ...
                        className="flex items-center space-x-1 text-gold-500 hover:text-gold-600"
                      >
